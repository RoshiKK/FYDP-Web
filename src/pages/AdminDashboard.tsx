  ...
  const handleBulkAction = (action: string) => {
    ...
    switch (action) {
      ...
      case "reject":
        ...
        break;
      case "assign":
        setAssignDialogOpen(true); // Manual department assignment (optional)
        break;
      case "clear":
        setSelectedIncidents([]);
        break;
                ...
                <TableRow key={incident._id} hover>
                  ...
                  <TableCell>
                    <Chip
                      ...
                      size="small"
                      sx={{
                        bgcolor: `${statusColors[incident.status] || "#6B7280"
                          }20`,
                  ...
                  <Grid item xs={12}>
                    ...
                    <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
                      {[
                        ...
                        <Chip
                          key={i}
                          label={`${t.label}: ${format(parseISO(t.value), "MMM dd, HH:mm")}`}
                          size="small"
                          sx={{
